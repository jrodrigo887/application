...
# Order Ease
> Order ease é uma pequena aplicação que representa uma estrutura básica de um sistema de pedidos de um Restaurante qualquer.


## Installation

Certifique está no path raiz do projeto e use o comando para baixar as dependências:
