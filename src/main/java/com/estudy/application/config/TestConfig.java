...
public class TestConfig implements CommandLineRunner {
    ...
    public void insertUserData() {
        ...
        Order ord1 = new Order(null, Instant.parse("2023-05-01T19:20:12Z"), us1);
        Order ord2 = new Order(null, Instant.parse("2023-05-01T20:08:26Z"), us1);
        Order ord3 = new Order(null, Instant.parse("2023-05-01T20:16:13Z"), us1);
        Order ord4 = new Order(null, Instant.parse("2023-05-01T18:16:13Z"), us2);
        Order ord5 = new Order(null, Instant.parse("2023-05-01T19:16:13Z"), us2);
